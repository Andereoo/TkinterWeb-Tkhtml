...
EGG_ROOT_PATH = os.path.join(ROOT_PATH, "tkinterweb_tkhtml.egg-info")
TKINTERWEB_ROOT_PATH = os.path.join(ROOT_PATH, "tkinterweb_tkhtml_extras")
TKINTERWEB_NEW_ROOT_PATH = os.path.join(WHEELS_ROOT_PATH, "tkinterweb_tkhtml_extras_")
TKINTERWEB_UTILITIES_FILE_NAME = "__init__.py"
    ...
    for path, directories, files in os.walk(src):
        ...
        for directory in directories:
            if directory not in ignore:
                ...
                if not os.path.exists(directory_dst_path):
