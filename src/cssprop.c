...
static const HashEntry aHtmlCssConstant[] = {
    ...
    {"inline-block", -101},
    {"inline-table", CSS_CONST_GRAB - 100},
    {"inset", -101},
    {"inside", CSS_CONST_GEORGIAN - 100},
    {"italic", CSS_CONST_CROSSHAIR - 100},
    {"justify", -101},
    {"large", CSS_CONST_AVOID - 100},
    {"larger", -101},
    {"left", -101},
    {"lighter", CSS_CONST_CONTEXT_MENU - 100},
    {"lime", CSS_CONST_INLINE_BLOCK - 100},
    {"line-through", -101},
    {"list-item", -101},
    {"lower-alpha", -101},
    {"lower-greek", -101},
    {"lower-latin", CSS_CONST_ALWAYS - 100},
    ...
    {"navy", -101},
    {"ne-resize", -101},
    {"nesw-resize", CSS_CONST_LOWER_ROMAN - 100},
    {"no-drop", CSS_CONST_BOLDER - 100},
    {"no-repeat", -101},
    {"none", -101},
    ...
    {"nwse-resize", CSS_CONST_NW_RESIZE - 100},
    {"oblique", CSS_CONST_NORMAL - 100},
    {"olive", CSS_CONST_LIST_ITEM - 100},
    {"outset", CSS_CONST_EW_RESIZE - 100},
    ...
    {"s-resize", CSS_CONST_GOBBLER - 100},
    {"scroll", -101},
    {"se-resize", CSS_CONST_ROW_RESIZE - 100},
    {"separate", -101},
    ...
    {"upper-roman", -101},
    {"uppercase", -101},
    {"vertical-text", CSS_CONST_COPY - 100},
    {"visible", -101},
    ...
    {"yellow", -101},
    {"zoom-in", CSS_CONST_X_SMALL - 100},
    {"zoom-out", CSS_CONST_SEPARATE - 100},
};
...
{
    int aTable[] = {
        CSS_CONST_LIME - 100, CSS_CONST_MEDIUM - 100, 
        CSS_CONST_COL_RESIZE - 100, CSS_CONST_RED - 100, -101, -101, 
        CSS_CONST_XX_SMALL - 100, CSS_CONST_TEXT_BOTTOM - 100, -101, 
        CSS_CONST_JUSTIFY - 100, CSS_CONST_TEXT - 100, CSS_CONST_TOP - 100, 
        CSS_CONST_MAROON - 100, CSS_CONST_TRANSPARENT - 100, -101, 
        CSS_CONST_SMALLER - 100, CSS_CONST_SUPER - 100, 
        CSS_CONST_VISIBLE - 100, -101, -101, CSS_CONST_NESW_RESIZE - 100, 
        CSS_CONST_BIDI_OVERRIDE - 100, -101, CSS_CONST_X_LARGE - 100, 
        CSS_CONST_CELL - 100, CSS_CONST_NOT_ALLOWED - 100, -101, 
        CSS_CONST_BASELINE - 100, CSS_CONST_INSIDE - 100, 
        CSS_CONST_SUB - 100, CSS_CONST_TEAL - 100, CSS_CONST_STATIC - 100, 
        CSS_CONST_ABSOLUTE - 100, -101, CSS_CONST_EMBED - 100, 
        CSS_CONST_FUCHSIA - 100, CSS_CONST_LOWER_GREEK - 100, -101, -101, 
        CSS_CONST_SCROLL - 100, CSS_CONST_PRE - 100, -101, 
        CSS_CONST_TABLE_COLUMN_GROUP - 100, CSS_CONST_LOWER_ALPHA - 100, 
        CSS_CONST_INLINE_TABLE - 100, CSS_CONST_ZOOM_OUT - 100, 
        CSS_CONST_CENTER - 100, CSS_CONST_NS_RESIZE - 100, 
        ...
        CSS_CONST_TABLE_CELL - 100, CSS_CONST_THICK - 100, 
        CSS_CONST_GRABBING - 100, -101, CSS_CONST_UNDERLINE - 100, 
        ...
        CSS_CONST_TABLE_FOOTER_GROUP - 100, CSS_CONST_WAIT - 100, 
        CSS_CONST_NWSE_RESIZE - 100, CSS_CONST_INHERIT - 100, 
        CSS_CONST_OUTSIDE - 100, CSS_CONST_ZOOM_IN - 100, 
        CSS_CONST_NO_DROP - 100, -101, CSS_CONST_CAPITALIZE - 100, 
        CSS_CONST_BOTH - 100, -101, CSS_CONST_SOLID - 100, 
        CSS_CONST_LOWERCASE - 100, -101, -101, -101, CSS_CONST_HELP - 100, 
        CSS_CONST_ALL_SCROLL - 100, CSS_CONST_THIN - 100, 
        CSS_CONST_RELATIVE - 100, CSS_CONST_ALIAS - 100, 
        ...
        CSS_CONST_MARKER - 100, CSS_CONST_VERTICAL_TEXT - 100, 
        CSS_CONST_LEFT - 100, CSS_CONST_DEFAULT - 100, 
        CSS_CONST_REPEAT - 100, CSS_CONST_SE_RESIZE - 100, 
        CSS_CONST_INLINE - 100, CSS_CONST_UPPER_ROMAN - 100, 
        CSS_CONST_N_RESIZE - 100, -101, CSS_CONST_YELLOW - 100, -101, -101, 
...
static const HashEntry aHtmlCssProperty[] = {
    ...
    {"border-spacing", -1},
    {"border-top-color", CSS_PROPERTY_BORDER_BOTTOM_LEFT_RADIUS - 0},
    ...
    {"overflow", -1},
    {"overflow-x", -1},
    {"overflow-y", CSS_PROPERTY_LETTER_SPACING - 0},
    {"padding-bottom", -1},
    {"padding-left", -1},
    ...
    {"play-during", -1},
    {"position", CSS_PROPERTY_OVERFLOW_Y - 0},
    ...
    {"speak-numeral", -1},
    {"speak-punctuation", -1},
    {"speech-rate", CSS_PROPERTY_BORDER_TOP_RIGHT_RADIUS - 0},
    {"stress", -1},
    {"table-layout", -1},
    ...
    {"width", -1},
    {"word-spacing", CSS_PROPERTY_OVERFLOW_X - 0},
    ...
    {"border-left", -1},
    {"border-radius", CSS_PROPERTY_BACKGROUND_COLOR - 0},
    {"border-right", CSS_PROPERTY_BORDER_COLLAPSE - 0},
    {"border-style", CSS_SHORTCUTPROPERTY_BORDER_RADIUS - 0},
    {"border-top", -1},
...
HtmlCssPropertyLookup(int n, const char *z)
{
    int aTable[] = {
        ...
        CSS_SHORTCUTPROPERTY_BORDER - 0, -1, 
        CSS_PROPERTY_BORDER_TOP_LEFT_RADIUS - 0, 
        CSS_SHORTCUTPROPERTY_BORDER_STYLE - 0, CSS_PROPERTY_CUE_BEFORE - 0, 
        CSS_PROPERTY_MARGIN_TOP - 0, -1, 
        CSS_PROPERTY_BORDER_BOTTOM_RIGHT_RADIUS - 0, 
        CSS_PROPERTY_PAUSE_BEFORE - 0, CSS_PROPERTY_BORDER_LEFT_COLOR - 0, 
        CSS_PROPERTY_CONTENT - 0, -1, CSS_PROPERTY_POSITION - 0, 
        CSS_PROPERTY_WORD_SPACING - 0, CSS_SHORTCUTPROPERTY_OUTLINE - 0, 
